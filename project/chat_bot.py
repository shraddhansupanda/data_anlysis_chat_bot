...
for x in range(1,a):
    ...
    try:
        ...
        if 'what' in y and ('lowest' in y or 'minimum' in y) and (('life' in y and 'expectancy' in y) or 'le' in y):
        ...
        if 'which' in y and 'country' in y and ('lowest' in y or 'minimum' in y) and (('life' in y and 'expectancy' in y) or 'le' in y) and 'on' not in y:
            highest_life_expectancy()
